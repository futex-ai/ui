...
const FORWARDING_FILES = [
  ...
  "chart/GaugeChart.tsx",
  "chart/HistogramChart.tsx",
  "chart/LineChart.tsx",
  "chart/MatrixHeatmap.tsx",
  "chart/ScaleLegend.tsx",
  "chart/ScatterChart.tsx",
  "chart/Sparkline.tsx",
  "chart/StatTile.tsx",
  "chart/WaterfallChart.tsx",
  ...
  "popover/ContextMenu.tsx",
  "popover/ContextMenu.web.tsx",
  "popover/Popover.tsx",
...
test("forwarding components declare an optional testID prop", () => {
  ...
  const sharedTypeFiles: Record<string, string> = {
    ...
    "chart/AreaChart.tsx": "chart/types.ts",
    "chart/BarChart.tsx": "chart/types.ts",
    "chart/DonutChart.tsx": "chart/types.ts",
    "chart/HistogramChart.tsx": "chart/types.ts",
    "chart/LineChart.tsx": "chart/types.ts",
    ...
    "popover/ContextMenu.tsx": "popover/contextMenuModel.ts",
    "popover/ContextMenu.web.tsx": "popover/contextMenuModel.ts",
