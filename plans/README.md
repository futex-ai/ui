...
- [Rich Text Editor component](rich-text-editor-component.md) — M1–M4 and M6 delivered; M7 fixes native first-responder transfer after Enter so the new block retains the keyboard and formatting toolbar. M5 remains the product backlog.
