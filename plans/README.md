...
- [Rich Text Editor component](rich-text-editor-component.md) — M8 fixes native Return ownership so one heading Return creates one paragraph without retaining a second local newline; M5 remains the post-v1 feature backlog.
