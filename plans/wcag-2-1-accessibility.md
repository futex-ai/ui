...
- **[1.4.11 active-row highlight (AA)] — Med — `dropdownListStyles.ts:56`** — `soft` highlight 1.13:1 → darker bg / accent bar / border (label-color shift alone is insufficient). **S**
